...
# The transfer conv body to use
# The string must match a function that is imported in modeling.model_builder
_C.MODEL.TRANSFER.CONV_BODY = "DLA-34-DCN"

# Add StopGrad at a specified stage so the bottom layers are frozen
_C.MODEL.TRANSFER.FREEZE_CONV_BODY_AT = 0
# Normalization for transfer
_C.MODEL.TRANSFER.USE_NORMALIZATION = "GN"
_C.MODEL.TRANSFER.DOWN_RATIO = 1
_C.MODEL.TRANSFER.BACKBONE_OUT_CHANNELS = 64
...
_C.MODEL.SMOKE_HEAD.USE_P = False
